...
TRAIN_FILE = (
    DATA_DIR
    / "v33_residual_learning_pilot_train.csv"
)


VALIDATION_FILE = (
    DATA_DIR
    / "v33_residual_learning_pilot_validation.csv"
)


FEATURE_FILE = (
    DATA_DIR
    / "v33_residual_learning_observable_features.txt"
)


MODEL_FILE = (
    MODEL_DIR
    / "v33_residual_rf_pilot.joblib"
)


PREDICTION_FILE = (
    RESULTS_DIR
    / "v33_residual_rf_pilot_validation_predictions.csv"
)


CV_FILE = (
    RESULTS_DIR
    / "v33_residual_rf_pilot_group_cv.csv"
)


SUMMARY_FILE = (
    RESULTS_DIR
    / "v33_residual_rf_pilot_summary.csv"
)


IMPORTANCE_FILE = (
    RESULTS_DIR
    / "v33_residual_rf_pilot_feature_importance.csv"
)
...
print(
    "V3.3 RESIDUAL-LEARNING PILOT TRAINING"
)
...
print(
    "V3.3 RESIDUAL-LEARNING PILOT TRAINING COMPLETED"
)
