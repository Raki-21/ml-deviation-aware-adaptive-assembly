...
RESULTS_DIR = (
    V33_ROOT
    / "results"
    / "residual_hybrid_closed_loop_pilot"
)
...
COMPONENT_RESULT_FILE = (
    RESULTS_DIR
    / "v33_residual_hybrid_closed_loop_component_results.csv"
)


ASSEMBLY_RESULT_FILE = (
    RESULTS_DIR
    / "v33_residual_hybrid_closed_loop_assembly_results.csv"
)


SUMMARY_FILE = (
    RESULTS_DIR
    / "v33_residual_hybrid_closed_loop_summary.csv"
)
...
print(
    "V3.3 RESIDUAL HYBRID CLOSED-LOOP PILOT"
)
...
print(
    "V3.3 CLOSED-LOOP HYBRID PILOT COMPLETED"
)
