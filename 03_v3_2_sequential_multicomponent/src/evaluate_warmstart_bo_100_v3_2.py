...
# IMPORTANT
#
# This is a 100-assembly controlled verification.
#
...
SUMMARY_OUTPUT = (
    "results/tables/"
    "v3_2_warmstart_bo_100_summary.csv"
)

STAGE_OUTPUT = (
    "results/tables/"
    "v3_2_warmstart_bo_100_by_stage.csv"
)
...
print(
    "V3.2 STRUCTURED WARM-START BO 100-ASSEMBLY VERIFICATION"
)
...
print(
    "This is the complete 100-assembly pilot verification."
)
